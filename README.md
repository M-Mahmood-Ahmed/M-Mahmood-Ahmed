...
I work on the stuff that breaks in production, not just in a notebook: LLM agents, scraping pipelines with LLM-based data enrichment, and reliability engineering around all of it.
